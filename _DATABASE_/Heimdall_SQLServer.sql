...
Create table Condena(
	ID_Condena int primary key identity(1,1),
...
Create table TipoCondena(
	ID_TipoCondena int primary key identity(1,1),
	Tipo varchar(50)
);
...
insert into Ciudadanos (CURP, Nombre, APaterno, AMaterno, FechaNac, Sexo, Direccion, Vive) values
('MEFL030925HDGDRSA1', 'Luis', 'Medrano', 'Fern�ndez', '2003-25-09', 'M', 'Calle 40 1619', 'S'),
('LIFO030323HDGRLSA8', 'Adrian', 'Lira', 'Flores', '2003-23-03', 'M', 'Pollos Hermanos', 'S'),
('ROMJ030511HDGBNA4', 'Jes�s', 'Robles', 'Mendoza', '2003-11-05', 'M', 'Las Canchas Luna', 'S');

insert into Vehiculos(Matricula,Modelo,Marca,Tipo,Descripcion,Nacionalidad,curpFK,A�o) values
...
(367, 'Robo', 'Se sanciona el apoderamiento de una cosa ajena sin consentimiento.','6 meses a 6 a�os', 20000.00),  
(209, 'Fraude', 'Quien enga�e para obtener un beneficio il�cito ser� sancionado.','3 meses a 3 a�os', 15000.00),  
(136, 'Homicidio', 'Al que prive de la vida a otro en ri�a','6 a 16 a�os', 240000.00);
...
('F000001F', 'Francisco', 'Palacios', 'Pe�aloza', 'M','Fuerzas Especiales', 'jefe de policia','$2b$10$XApdznvQdeGkoC4QeDtW.OJbMZKXQjHse1ctSWLhE00Q0iyA1UeVq'),
...
('2025-11-03',6,240000.00,'P',3),
('2024-15-05',3,15000.00,'P',2),
('2025-09-01',1,10000.00,'P',1),
('2025-10-02',8,1000.00,'P',4)
